 This aims to be a digital version of the Lord of the Rings LCG game using boardgame.io. It has no affiliation with Fantasy Flight Games.

 To run the application, run `npm start` in the project directory, and then visit `http://localhost:3000`.

TODO: Remove below documentation generated by Create React App.
